...
<section>
    <div class="flex flex-col md:py-24 p-4 h-screen w-screen justify-center items-center">
        <div class="md:w-1/3 w-full bg-primary rounded-t-xl flex justify-center items-center flex-col py-4 ">
        ...
        <div class="md:w-1/3 w-full bg-white rounded-b-2xl px-8 py-6 flex flex-col justify-center items-center">
